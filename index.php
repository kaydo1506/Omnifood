    ...
    <body>
        <header>
            ...
            <div class="hero-text-box">
                ...
                <p class="showing-off">Website by Ify Okedo</p>
        ...
        <section class="section-meals">
            <ul class="meals-showcase clearfix">
                <li>
                    <figure class="meal-photo">
                        <img src="resources/img/food1.jpg" alt="Eba and egusi soup" />
                    </figure>
                </li>

                <li>
                    <figure class="meal-photo">
                        <img src="resources/img/food2.jpg" alt="Akara and Akamu" />
                    </figure>
                </li>

                <li>
                    <figure class="meal-photo">
                        <img src="resources/img/food3.jpg" alt="Fish Peppersoup" />
                    </figure>
                </li>
            ...
            <ul class="meals-showcase clearfix">
                <li>
                    <figure class="meal-photo">
                        <img src="resources/img/9.jpg" alt="Paleo beef steak with vegetables" />
                    </figure>
                </li>

                <li>
                    <figure class="meal-photo">
                        <img src="resources/img/10.jpg" alt="Healthy baguette with egg and vegetables" />
                    </figure>
                </li>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="resources/img/Abuja.jpg" alt="Abuja City" />
                    <h3>Abuja</h3>
                    ...
                    <div class="city-feature">
                        ...
                        <a href="#">@omnifood_Abj</a>
                    </div>
                </div>

                <div class="col span-1-of-4 box">
                    <img src="resources/img/lagos1.jpg" alt="Lagos City" />
                    <h3>Lagos</h3>
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
                        3700+ happy eaters
                    ...
                    <div class="city-feature">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#">@Omnifood_Lagos</a>
                    </div>
                </div>

                <div class="col span-1-of-4 box">
                    <img src="resources/img/portharcort.jpg" alt="portharcort City" />
                    <h3>Portharcort</h3>
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
                        2300+ happy eaters
                    ...
                    <div class="city-feature">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#">@Omnifood_Ph</a>
                    </div>
                </div>

                <div class="col span-1-of-4 box">
                    <img src="resources/img/Awka247.jpg" alt="Awka City" />
                    <h3>Awka</h3>
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
                        1200+ happy eaters
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/img/customer-4.jpeg" alt="Customer 1 photo" />Rachael Hills</cite>
                    </blockquote>
                </div>
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        delivery here in Abuja, but no one comes even close to Omifood. Me and my family are so in love!
                        <cite><img src="resources/img/customer-5.jpeg" alt="Customer 2 photo" />Cynthia Henry</cite>
                    </blockquote>
                </div>

                <div class="col span-1-of-3">
                    <blockquote>
                        I was looking for a quick and easy food delivery service in Lagos. I tried a lot of them and
                        ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                        <cite><img src="resources/img/customer-6.jpeg" alt="Customer 3 photo" />Ebuka Hills</cite>
                    </blockquote>
                </div>
            </div>
        </section>
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <div class="plan-box js--wp-4">
                        <div>
                            <h3>Premium</h3>
                            <p class="plan-price">&#8358;20,000 <span>/ month</span></p>
                            <p class="plan-price-meal">That's only &#8358;645,16 per meal</p>
                        </div>
                        <div>
                            <ul>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        <div>
                            <h3>Pro</h3>
                            <p class="plan-price">&#8358;15,000 <span>/ month</span></p>
                            <p class="plan-price-meal">That's only &#8358;483.87 per meal</p>
                        </div>
                        <div>
                            <ul>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        <div>
                            <h3>Starter</h3>
                            <p class="plan-price">&#8358;600 <span>/ meal</span></p>
                            <p class="plan-price-meal">&nbsp;</p>
                        </div>
                        <div>
                            <ul>
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>1 meal</li>
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>Order 8am to 12pm</li>
                ...
                <div class="row">
                    <form method="post" action="mailer.php" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col span-2-of-3">
                                <input class="btn-add-cursor" type="submit" value="Send it!" />
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2019 by Ify Okedo. All rights reserved.
                </p>
            </div>
        </footer>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-152048627-1"></script>
        <script>
